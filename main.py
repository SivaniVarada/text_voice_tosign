...
while 1:
    image = "signlogo.png"
    msg = "Speech and Text to Sign Language"
    choices = ["Live Voice", "Text", "Exit"]
    ...
    if reply == choices[1]:
        ...
        img = ImageTk.PhotoImage(Image.open("signlogo.png"))
        l = tk.Label(root1, image=img)
        l.pack()
        mylabel = tk.Label(root1, text="Enter the text you want sign language for:", font=("Courier", 11))
        mylabel.pack()
        ...
        e = tk.Entry(root1)
        e.pack()
        button1 = tk.Button(root1, text="Enter", font=("Courier", 11), command=enterfunc)
        button1.pack()
        root1.mainloop()
